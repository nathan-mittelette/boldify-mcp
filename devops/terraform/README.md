...
| <a name="input_lambdas"></a> [lambdas](#input\_lambdas) | n/a | <pre>set(object({<br/>    name        = string<br/>    output      = string<br/>    source      = string<br/>    description = string<br/>    memory      = string<br/>    timeout     = string<br/>    runtime     = string<br/>    handler     = string<br/>    https = list(object({<br/>      method = string<br/>      path   = string<br/>    }))<br/>    layers       = optional(list(string), [])<br/>    environments = optional(map(string), {})<br/>  }))</pre> | n/a | yes |
